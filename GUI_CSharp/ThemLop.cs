...
namespace GUI_CSharp
{
    public partial class ThemLop : MaterialForm
    {
        public ThemLop()
        {
            ...
            txGiaoVien.DataSource = list.getGiaoVienList();
            txGiaoVien.DisplayMember = "HoTen";
            txGiaoVien.ValueMember = "MaGiaoVien";
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            // Kiểm tra Giáo Viên
            if (txGiaoVien.SelectedValue == null)
            {
                MessageBox.Show("Vui lòng chọn giáo viên.");
                return;
            }
            string textGiaoVien = txGiaoVien.SelectedValue.ToString();
